...
<body>
    ...
    <div id="loginForm" class="auth-container">
        ...
        <div class="auth-right">
            ...
            <form id="loginFormElement" action="./auth//login.php" method="post">
    ...
    <div id="signupForm" class="auth-container hidden">
        ...
        <div class="auth-right">
            ...
            <form id="signupFormElement" action="./auth/register.php" method="post">
                <!-- Step 1: Basic Info -->
                <div class="signup-step active" data-step="1">
                    <div class="form-group">
                        <label class="form-label">Employee ID</label>
                        <input type="text" id="employeeId" class="form-control" placeholder="Enter your employee ID" name="employeeID" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="signupEmail" class="form-control" placeholder="Enter your email" name="email" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Phone Number</label>
                        <input type="tel" id="phone" class="form-control" placeholder="Enter your phone number" name="phone" required>
                    </div>
                </div>
                ...
                <div class="signup-step" data-step="2">
                    <div class="form-group">
                        <label class="form-label">Password</label>
                        <div class="input-wrapper">
                            <input type="password" id="signupPassword" class="form-control" placeholder="Create a strong password" name="password" required oninput="checkStrength()">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="password" id="confirmPassword" class="form-control" placeholder="Re-enter your password" name="confirmPassword" required>
                ...
                <div class="signup-step" data-step="3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="position" class="form-control" placeholder="e.g., Software Engineer" name="position" required>
                    </div>
                    <div class="remember-me">
                        <input type="checkbox" id="agreeTerms" required name="checkbox">
